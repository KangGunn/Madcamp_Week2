...
public class SearchActivity extends BaseActivity { // BaseActivity를 상속받음
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Context와 Activity가 null인지 확인
        if (this == null || getApplicationContext() == null) {
            throw new IllegalStateException("Context is null. Ensure activity is properly initialized.");
        }
...
//        // SearchActivity에 표시할 레이아웃 설정
    ...
    protected void setupViews() {
        ...
        if (recyclerView == null) {
            Log.e(TAG, "RecyclerView is null. Check if activity_search is properly loaded.");
            return;
        }
        ...
        Log.d(TAG, "RecyclerView initialized with adapter: " + recyclerView.getAdapter());
