...
public class CourseResponse {
    ...
    private String shared_course;
    private String prev_com_code;
    ...
    public String getSharedCourse() { return shared_course; }
    public void setSharedCourse(String shared_course) { this.shared_course = shared_course; }
    public String getPrevComCode() { return prev_com_code; }
    public void setPrevComCode(String prev_com_code) { this.prev_com_code = prev_com_code; }
    public String getSubCode() { return sub_code; }
    public void setSubCode(String sub_code) { this.sub_code = sub_code; }
    ...
    public String getLpc() { return lpc; }
    public void setLpc(String lpc) { this.lpc = lpc; }
    public String getLectureTime() { return lecture_time; }
    public void setLectureTime(String lecture_time) { this.lecture_time = lecture_time; }
    public String getLectureRoom() { return lecture_room; }
    public void setLectureRoom(String lecture_room) { this.lecture_room = lecture_room; }
